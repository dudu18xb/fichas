...
<div class="login-box">
    <div class="login-logo">
        <a href="/"><b>Busca de Fichas </b>Xambrê</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Preenche o Formúlario abaixo para efetuar login</p>
        <?= $this->Form->create() ?>
...
<!-- jQuery 2.2.3 -->
<script src="/admin_l_t_e/plugins/jQuery/jquery-2.2.3.min.js"></script><!-- Bootstrap 3.3.6 -->
<script src="/admin_l_t_e/bootstrap/js/bootstrap.min.js"></script><!-- iCheck -->
