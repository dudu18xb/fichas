                            ...
                            <div class="news_post_content">
                                ...
                                <div class="news_post_info">
                                    <ul class="d-flex flex-row align-items-center justify-content-start">
                                        <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i> <?php echo h($blog->autore->nome) ?>
                                            </a></li>
            ...
            <div class="col-lg-4">
                <div class="news_sidebar">
                    ...
                    <div class="sidebar_search">
                        <?php echo $this->Form->create(null, ['valueSources' => 'blogs', 'class' => 'sidebar_search', 'id' => 'sidebar_search']); ?>
                        <?php echo $this->Form->control('q', ['label' => false, 'type' => 'text', 'class' => 'sidebar_search_input', 'placeholder' => 'Buscar por título']); ?>
                        <button class="sidebar_search_button" type="submit"><i class="fa fa-search" aria-hidden="true"></i></button>
